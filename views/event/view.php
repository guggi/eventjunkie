                ...
                <div class="<?= ($socialmedia_comment['site_name'] == 'Twitter') ? 'panel panel-info' : 'panel panel-primary' ?>">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                <strong> <a href="<?= $socialmedia_comment['author_url'] ?>"><?= $socialmedia_comment['author'] ?></a></strong><br>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-8">
                                    <small> – <a href="<?= $socialmedia_comment['url'] ?>"><?= $socialmedia_comment['title'] ?></a>
                                        on <a href="<?= $socialmedia_comment['socialmedia_url'] ?>"><cite title="source"><?= $socialmedia_comment['site_name'] ?></cite></a></small>
                                </div>
                                <?php if (isset($socialmedia_comment['answers']) && count($socialmedia_comment['answers']) > 0) { ?>
                                    <div class="col-md-4">
                            ...
                            <?php if (isset($socialmedia_comment['answers']) && count($socialmedia_comment['answers']) > 0) { ?>
                                <div class="col-md-12" id="accordion" role="tablist" aria-multiselectable="true">
                                    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body">
                                            <?php foreach ($socialmedia_comment['answers'] as $socialmedia_answer) { ?>
                                                <div class="<?= ($socialmedia_comment['site_name'] == 'Twitter') ? 'panel panel-info' : 'panel panel-primary' ?>">
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <div class="col-md-11">
                                                                <strong><a href="<?= $socialmedia_answer['author_url'] ?>"><?= $socialmedia_answer['author'] ?></a></strong>
                                                                <small class="text-muted"><?= date("d.m.Y G:i", $socialmedia_answer['date']) ?></small>
                                                                <?= Html::encode($socialmedia_answer['text']) ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<div class="col-md-4">
    ...
    if (isset($socialmedia['images'])) { ?>
        ...
        <div class="col-md-12">
            <a href="<?= \Yii::$app->request->BaseUrl.'/index.php?r=event/gallery&id='.$model->id ?>">View Gallery</a>
            <hr>
        </div>
        <div class="col-md-12">
            <div id="links">
